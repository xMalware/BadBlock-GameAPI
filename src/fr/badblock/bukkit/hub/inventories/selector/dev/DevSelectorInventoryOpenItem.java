...
public class DevSelectorInventoryOpenItem extends CustomItem {

	public DevSelectorInventoryOpenItem() {
		super("hub.items.devinventory.open", Material.COMMAND);
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		DevSelectorInventory.inventory.open(player);	
	}
