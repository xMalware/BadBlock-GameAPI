...
public class Rush4x4SelectorItem extends SubGameSelectorItem {

	@SuppressWarnings("deprecation")
	public Rush4x4SelectorItem() {
		super("hub.items.rushselectoritem.4x4", Material.BANNER, DyeColor.RED.getDyeData(),
				"hub.items.rushselectoritem.4x4.lore");
	}
	...
	public List<String> getGames() {
		return Arrays.asList("rush4x4wb");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		Runnable runnable = new Runnable() {
			@Override
			public void run() {
				service.sendAsyncPacket("networkdocker.sentry.join", gson.toJson(new SEntry(player.getName(), "rush4x4wb", false)),
