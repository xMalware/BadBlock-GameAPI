...
public class Tower8v8SelectorItem extends SubGameSelectorItem {

	@SuppressWarnings("deprecation")
	public Tower8v8SelectorItem() {
		super("hub.items.towerselectoritem.8v8", Material.BANNER, DyeColor.LIME.getDyeData(),
				"hub.items.towerselectoritem.8v8.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		Runnable runnable = new Runnable() {
			@Override
			public void run() {
				service.sendAsyncPacket("networkdocker.sentry.join", gson.toJson(new SEntry(player.getName(), "tower8v8", false)),
