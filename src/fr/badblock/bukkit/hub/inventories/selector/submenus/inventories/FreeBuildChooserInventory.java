...
import fr.badblock.bukkit.hub.inventories.selector.submenus.items.freebuild.FreeBuildBravoSelectorItem;
...
public class FreeBuildChooserInventory extends CustomInventory {
	...
	public FreeBuildChooserInventory() {
		...
		this.setItem(21, new FreeBuildAlphaSelectorItem());
		this.setItem(23, new FreeBuildBravoSelectorItem());
