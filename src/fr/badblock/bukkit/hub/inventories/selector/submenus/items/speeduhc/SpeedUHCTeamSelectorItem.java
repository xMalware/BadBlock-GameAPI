package fr.badblock.bukkit.hub.inventories.selector.submenus.items.speeduhc;
...
public class SpeedUHCTeamSelectorItem extends SubGameSelectorItem {

	@SuppressWarnings("deprecation")
	public SpeedUHCTeamSelectorItem() {
		super("hub.items.speeduhcselectoritem.team", Material.BANNER, DyeColor.BLUE.getDyeData(),
				"hub.items.speeduhcselectoritem.team.lore");
	}
	...
	public List<String> getGames() {
		return Arrays.asList("speeduhct");
	}
