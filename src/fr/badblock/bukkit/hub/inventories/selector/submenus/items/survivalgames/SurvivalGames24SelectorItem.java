...
public class SurvivalGames24SelectorItem extends SubGameSelectorItem {

	@SuppressWarnings("deprecation")
	public SurvivalGames24SelectorItem() {
		super("hub.items.survivalgamesselectoritem.24", Material.BANNER, DyeColor.GREEN.getDyeData(),
				"hub.items.survivalgamesselectoritem.24.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		Runnable runnable = new Runnable() {
			@Override
			public void run() {
				service.sendAsyncPacket("networkdocker.sentry.join", gson.toJson(new SEntry(player.getName(), "sg24", false)),
