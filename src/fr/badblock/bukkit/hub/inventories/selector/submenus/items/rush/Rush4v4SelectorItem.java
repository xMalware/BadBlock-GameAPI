...
public class Rush4v4SelectorItem extends SubGameSelectorItem {

	@SuppressWarnings("deprecation")
	public Rush4v4SelectorItem() {
		super("hub.items.rushselectoritem.4v4", Material.BANNER, DyeColor.RED.getDyeData(),
				"hub.items.rushselectoritem.4v4.lore");
	}
	...
	public List<String> getGames() {
		return Arrays.asList("rush4v4wb");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		Runnable runnable = new Runnable() {
			@Override
			public void run() {
				service.sendAsyncPacket("networkdocker.sentry.join", gson.toJson(new SEntry(player.getName(), "rush4v4wb", false)),
