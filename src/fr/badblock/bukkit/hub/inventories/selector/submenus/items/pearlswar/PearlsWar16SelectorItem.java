package fr.badblock.bukkit.hub.inventories.selector.submenus.items.pearlswar;
...
public class PearlsWar16SelectorItem extends SubGameSelectorItem {

	@SuppressWarnings("deprecation")
	public PearlsWar16SelectorItem() {
		super("hub.items.pearlswarselectoritem.16", Material.BANNER, DyeColor.CYAN.getDyeData(),
				"hub.items.pearlswarselectoritem.16.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		Runnable runnable = new Runnable() {
			@Override
			public void run() {
				service.sendAsyncPacket("networkdocker.sentry.join", gson.toJson(new SEntry(player.getName(), "pw16", false)),
