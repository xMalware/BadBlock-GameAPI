...
public class TowerWBPaperItem extends CustomItem {

	public TowerWBPaperItem() {
		super("hub.items.towerselectoritem.paper_wb_displayname", Material.PAPER, "hub.items.towerselectoritem.paper_wb_lore");
	}
