...
public class Rush4x1SelectorItem extends SubGameSelectorItem {

	@SuppressWarnings("deprecation")
	public Rush4x1SelectorItem() {
		super("hub.items.rushselectoritem.4x1", Material.BANNER, DyeColor.RED.getDyeData(),
				"hub.items.rushselectoritem.4x1.lore");
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		Runnable runnable = new Runnable() {
			@Override
			public void run() {
				service.sendAsyncPacket("networkdocker.sentry.join", gson.toJson(new SEntry(player.getName(), "rush4x1", false)),
