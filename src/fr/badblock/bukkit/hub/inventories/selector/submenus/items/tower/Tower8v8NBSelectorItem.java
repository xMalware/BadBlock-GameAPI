...
public class Tower8v8NBSelectorItem extends SubGameSelectorItem {

	@SuppressWarnings("deprecation")
	public Tower8v8NBSelectorItem() {
		super("hub.items.towerselectoritem.8v8nb", Material.BANNER, DyeColor.RED.getDyeData(),
				"hub.items.towerselectoritem.8v8nb.lore");
	}
	...
	public List<String> getGames() {
		return Arrays.asList("tower8v8nb");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		Runnable runnable = new Runnable() {
			@Override
			public void run() {
				service.sendAsyncPacket("networkdocker.sentry.join", gson.toJson(new SEntry(player.getName(), "tower8v8nb", false)),
