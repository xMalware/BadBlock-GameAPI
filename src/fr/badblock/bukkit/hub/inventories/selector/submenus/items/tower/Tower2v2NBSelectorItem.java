...
public class Tower2v2NBSelectorItem extends SubGameSelectorItem {

	@SuppressWarnings("deprecation")
	public Tower2v2NBSelectorItem() {
		super("hub.items.towerselectoritem.2v2nb", Material.BANNER, DyeColor.RED.getDyeData(),
				"hub.items.towerselectoritem.2v2nb.lore");
	}
	...
	public List<String> getGames() {
		return Arrays.asList("tower2v2nb");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		Runnable runnable = new Runnable() {
			@Override
			public void run() {
				service.sendAsyncPacket("networkdocker.sentry.join", gson.toJson(new SEntry(player.getName(), "tower2v2nb", false)),
