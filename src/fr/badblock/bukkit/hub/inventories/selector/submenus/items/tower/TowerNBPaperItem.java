...
public class TowerNBPaperItem extends CustomItem {

	public TowerNBPaperItem() {
		super("hub.items.towerselectoritem.paper_nb_displayname", Material.PAPER, "hub.items.towerselectoritem.paper_nb_lore");
	}
