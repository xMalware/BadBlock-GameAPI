...
public class Rush4v4NBSelectorItem extends SubGameSelectorItem {

	@SuppressWarnings("deprecation")
	public Rush4v4NBSelectorItem() {
		super("hub.items.rushselectoritem.4v4nb", Material.BANNER, DyeColor.RED.getDyeData(),
				"hub.items.rushselectoritem.4v4nb.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		Runnable runnable = new Runnable() {
			@Override
			public void run() {
				service.sendAsyncPacket("networkdocker.sentry.join", gson.toJson(new SEntry(player.getName(), "rush4v4", false)),
