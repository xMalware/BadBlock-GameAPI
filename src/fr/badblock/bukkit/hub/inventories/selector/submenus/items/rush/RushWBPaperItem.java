...
public class RushWBPaperItem extends CustomItem {

	public RushWBPaperItem() {
		super("hub.items.rushselectoritem.paper_wb_displayname", Material.PAPER, "hub.items.rushselectoritem.paper_wb_lore");
	}
