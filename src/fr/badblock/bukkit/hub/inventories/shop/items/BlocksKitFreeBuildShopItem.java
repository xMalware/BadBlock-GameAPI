...
public class BlocksKitFreeBuildShopItem extends CustomItem {

	public BlocksKitFreeBuildShopItem() {
		super("hub.items.blockskitfreebuildshopitem.displayname", Material.STAINED_GLASS, (byte) 14, "hub.items.blockskitfreebuildshopitem.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		instance.getShopLinkerAPI().sendShopdata("freebuild", player.getName(), "KitBlocks");
