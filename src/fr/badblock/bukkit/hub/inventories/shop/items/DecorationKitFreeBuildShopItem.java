...
public class DecorationKitFreeBuildShopItem extends CustomItem {

	public DecorationKitFreeBuildShopItem() {
		super("hub.items.decorationkitfreebuildshopitem.displayname", Material.BOOKSHELF, "hub.items.decorationkitfreebuildshopitem.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		instance.getShopLinkerAPI().sendShopdata("freebuild", player.getName(), "KitDeco");
