...
public class ImmortalFactionShopItem extends CustomItem {

	public ImmortalFactionShopItem() {
		super("hub.items.immortalfactionshopitem.displayname", Material.DIAMOND_CHESTPLATE, "hub.items.immortalfactionshopitem.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		instance.getShopLinkerAPI().sendShopdata("faction", player.getName(), "Immortel");
