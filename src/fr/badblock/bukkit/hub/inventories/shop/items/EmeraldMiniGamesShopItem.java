...
public class EmeraldMiniGamesShopItem extends CustomItem {

	public EmeraldMiniGamesShopItem() {
		super("hub.items.emeraldminigamesshopitem.displayname", Material.EMERALD, "hub.items.emeraldminigamesshopitem.lore");
	}
