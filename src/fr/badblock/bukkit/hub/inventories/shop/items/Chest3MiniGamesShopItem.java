...
public class Chest3MiniGamesShopItem extends CustomItem {

	public Chest3MiniGamesShopItem() {
		super("hub.items.chest3minigamesshopitem.displayname", Material.ENDER_CHEST, "hub.items.chest3minigamesshopitem.lore");
	}
