...
public class DiamondMiniGamesShopItem extends CustomItem {

	public DiamondMiniGamesShopItem() {
		super("hub.items.diamondminigamesshopitem.displayname", Material.DIAMOND, "hub.items.diamondminigamesshopitem.lore");
	}
