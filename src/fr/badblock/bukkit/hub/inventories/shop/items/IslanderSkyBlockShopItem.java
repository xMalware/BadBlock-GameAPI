...
public class IslanderSkyBlockShopItem extends CustomItem {

	public IslanderSkyBlockShopItem() {
		super("hub.items.islanderskyblockshopitem.displayname", Material.DIRT, (byte) 2, "hub.items.islanderskyblockshopitem.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		instance.getShopLinkerAPI().sendShopdata("skyblock", player.getName(), "Islander");
