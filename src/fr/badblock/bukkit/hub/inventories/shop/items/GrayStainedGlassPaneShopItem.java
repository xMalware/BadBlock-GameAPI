...
public class GrayStainedGlassPaneShopItem extends CustomItem {

	public GrayStainedGlassPaneShopItem() {
		super("hub.items.graystainedglasspaneshopitem", Material.STAINED_GLASS_PANE, (byte) 7);
	}
