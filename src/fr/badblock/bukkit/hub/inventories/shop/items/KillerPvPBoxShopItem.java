...
public class KillerPvPBoxShopItem extends CustomItem {

	public KillerPvPBoxShopItem() {
		super("hub.items.killerpvpboxshopitem.displayname", Material.IRON_SWORD, "hub.items.killerpvpboxshopitem.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		instance.getShopLinkerAPI().sendShopdata("pvpbox", player.getName(), "Assassin");
