...
public class SkylanderSkyBlockShopItem extends CustomItem {

	public SkylanderSkyBlockShopItem() {
		super("hub.items.skylanderskyblockshopitem.displayname", Material.GRASS, "hub.items.skylanderskyblockshopitem.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		instance.getShopLinkerAPI().sendShopdata("skyblock", player.getName(), "Skylander");
