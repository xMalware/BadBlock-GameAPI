...
public class MastodonPvPBoxShopItem extends CustomItem {

	public MastodonPvPBoxShopItem() {
		super("hub.items.mastodonpvpboxshopitem.displayname", Material.DIAMOND_SWORD, "hub.items.mastodonpvpboxshopitem.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		instance.getShopLinkerAPI().sendShopdata("pvpbox", player.getName(), "Mastodonte");
