...
public class Chest2MiniGamesShopItem extends CustomItem {

	public Chest2MiniGamesShopItem() {
		super("hub.items.chest2minigamesshopitem.displayname", Material.ENDER_CHEST, "hub.items.chest2minigamesshopitem.lore");
	}
