...
public class Chest1MiniGamesShopItem extends CustomItem {

	public Chest1MiniGamesShopItem() {
		super("hub.items.chest1minigamesshopitem.displayname", Material.ENDER_CHEST, "hub.items.chest1minigamesshopitem.lore");
	}
