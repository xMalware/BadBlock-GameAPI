...
public class ArchitectFreeBuildShopItem extends CustomItem {

	@SuppressWarnings("deprecation")
	public ArchitectFreeBuildShopItem() {
		super("hub.items.architectfreebuildshopitem.displayname", Material.getMaterial(45), "hub.items.architectfreebuildshopitem.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		instance.getShopLinkerAPI().sendShopdata("freebuild", player.getName(), "Architecte");
