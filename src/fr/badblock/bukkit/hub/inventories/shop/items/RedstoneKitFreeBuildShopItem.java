...
public class RedstoneKitFreeBuildShopItem extends CustomItem {

	public RedstoneKitFreeBuildShopItem() {
		super("hub.items.redstonekitfreebuildshopitem.displayname", Material.REDSTONE_BLOCK, "hub.items.redstonekitfreebuildshopitem.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		instance.getShopLinkerAPI().sendShopdata("freebuild", player.getName(), "KitRedstone");
