...
public class BuilderFreeBuildShopItem extends CustomItem {

	public BuilderFreeBuildShopItem() {
		super("hub.items.builderfreebuildshopitem.displayname", Material.GRASS, "hub.items.builderfreebuildshopitem.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		instance.getShopLinkerAPI().sendShopdata("freebuild", player.getName(), "Constructeur");
