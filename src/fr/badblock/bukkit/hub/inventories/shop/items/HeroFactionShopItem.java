...
public class HeroFactionShopItem extends CustomItem {

	public HeroFactionShopItem() {
		super("hub.items.herofactionshopitem.displayname", Material.LEATHER_CHESTPLATE, "hub.items.herofactionshopitem.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		instance.getShopLinkerAPI().sendShopdata("faction", player.getName(), "Heros");
