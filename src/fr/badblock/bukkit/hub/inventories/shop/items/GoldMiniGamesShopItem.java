...
public class GoldMiniGamesShopItem extends CustomItem {

	public GoldMiniGamesShopItem() {
		super("hub.items.goldminigamesshopitemv", Material.GOLD_INGOT, "hub.items.goldminigamesshopitem.lore");
	}
