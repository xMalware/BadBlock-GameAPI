...
public class TitanFactionShopItem extends CustomItem {

	public TitanFactionShopItem() {
		super("hub.items.titanfactionshopitem.displayname", Material.CHAINMAIL_CHESTPLATE, "hub.items.titanfactionshopitem.lore");
	}
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		instance.getShopLinkerAPI().sendShopdata("faction", player.getName(), "Titan");
