...
import fr.badblock.bukkit.hub.effectlib.effect.DiscoBallEffect;
import fr.badblock.bukkit.hub.inventories.market.cosmetics.particles.defaults.ParticleItem;
import fr.badblock.bukkit.hub.objects.HubPlayer;
import fr.badblock.gameapi.players.BadblockPlayer;

public class DiscoBallParticleItem extends ParticleItem {

	public DiscoBallParticleItem() {
		super("discoball");
	}
	...
	protected Effect run(BadblockPlayer player, HubPlayer hubPlayer) {
		DiscoBallEffect effect = new DiscoBallEffect(getEffectManager());
