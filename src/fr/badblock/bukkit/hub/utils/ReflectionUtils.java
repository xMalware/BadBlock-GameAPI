...
public final class ReflectionUtils {
	public static enum DataType {
		BOOLEAN(Boolean.TYPE, Boolean.class), BYTE(Byte.TYPE, Byte.class), CHARACTER(Character.TYPE,
				Character.class), DOUBLE(Double.TYPE, Double.class), FLOAT(Float.TYPE, Float.class), INTEGER(
						Integer.TYPE, Integer.class), LONG(Long.TYPE, Long.class), SHORT(Short.TYPE, Short.class);
