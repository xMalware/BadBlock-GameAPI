...
public class WorkerListener extends RabbitListener {
	
	public static double bungeeWorkers = 1; // un seul bungee qui work et qui te fetch dessus
	
	public WorkerListener() {
		super(BadBlockHub.getInstance().getRabbitService(), "ladder.bungeeWorker", false, RabbitListenerType.SUBSCRIBER);
	}
