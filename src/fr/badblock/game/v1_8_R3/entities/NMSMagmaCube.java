...
public class NMSMagmaCube extends EntityMagmaCube implements CustomCreature {
	@Getter
    ...
    protected void regenerateAttributes(){
	    ...
	    this.goalSelector.a(2, getPrivateGoal("PathfinderGoalSlimeRandomJump", new Class<?>[]{EntitySlime.class}, this));
	    this.goalSelector.a(2, getPrivateGoal("PathfinderGoalSlimeRandomDirection", new Class<?>[]{EntitySlime.class}, this));
	    this.goalSelector.a(2, getPrivateGoal("PathfinderGoalSlimeIdle", new Class<?>[]{EntitySlime.class}, this));
	    this.goalSelector.a(2, getPrivateGoal("PathfinderGoalSlimeNearestPlayer", new Class<?>[]{EntitySlime.class}, this));
    ...
    private PathfinderGoal getPrivateGoal(String name, Class<?>[] forConstructor, Object... objects){
		try {
			...
			for(Class<?> clazz : EntitySlime.class.getDeclaredClasses()){
