...
public class NMSSilverfish extends EntitySilverfish implements CustomCreature {
	@Getter
	...
	protected void regenerateAttributes(){
	    ...
	    this.goalSelector.a(5, getPrivateGoal("PathfinderGoalSilverfishHideInBlock", new Class<?>[]{EntitySilverfish.class}, this));
