...
public class NMSPigZombie extends EntityPigZombie implements CustomCreature {
	@Getter
    ...
    protected void regenerateAttributes(){
		...
		this.targetSelector.a(2, getPrivateGoal("PathfinderGoalAngerOther", new Class<?>[]{EntityPigZombie.class}, this));
		this.targetSelector.a(2, getPrivateGoal("PathfinderGoalAnger", new Class<?>[]{EntityPigZombie.class}, this));
	}
    ...
    private PathfinderGoal getPrivateGoal(String name, Class<?>[] forConstructor, Object... objects){
		try {
			...
			for(Class<?> clazz : EntityPigZombie.class.getDeclaredClasses()){
