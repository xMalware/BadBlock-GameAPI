...
public class NMSGhast extends EntityGhast implements CustomCreature {
	@Getter
	...
	protected void regenerateAttributes(){
	    ...
	    this.goalSelector.a(5, getPrivateGoal("PathfinderGoalGhastIdleMove", new Class[]{EntityGhast.class}, this));
	    
		if(!agressive) return;
		
	    this.goalSelector.a(7, getPrivateGoal("PathfinderGoalGhastMoveTowardsTarget", new Class[]{EntityGhast.class}, this));
	    this.goalSelector.a(7, getPrivateGoal("PathfinderGoalGhastAttackTarget", new Class[]{EntityGhast.class}, this));
