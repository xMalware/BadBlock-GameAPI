...
public class NMSWither extends EntityWither implements CustomCreature {
	@Getter
	...
	protected void regenerateAttributes(){
	    ...
	    try {
			this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityInsentient.class, 0, false, false, (Predicate<?>) new Reflector(this).getStaticFieldValue("bq")));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
