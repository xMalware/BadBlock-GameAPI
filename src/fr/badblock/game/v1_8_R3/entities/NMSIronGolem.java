...
public class NMSIronGolem extends EntityIronGolem implements CustomCreature {
	@Getter
	...
	protected void regenerateAttributes(){
		...
		if(!agressive) this.goalSelector.a(1, new PathfinderGoalPanic(this, 1.25D));
	    ...
	    this.targetSelector.a(3, getPrivateGoal("PathfinderGoalNearestGolemTarget", new Class<?>[]{
	...
	private PathfinderGoal getPrivateGoal(String name, Class<?>[] forConstructor, Object... objects){
		try {
			...
			for(Class<?> clazz : EntityIronGolem.class.getDeclaredClasses()){
