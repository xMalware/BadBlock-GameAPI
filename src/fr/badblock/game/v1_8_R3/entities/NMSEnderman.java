...
public class NMSEnderman extends EntityEnderman implements CustomCreature {
	@Getter
	...
	protected void regenerateAttributes(){
		...
		this.targetSelector.a(2, getPrivateGoal("PathfinderGoalPlayerWhoLookedAtTarget", new Class<?>[]{EntityEnderman.class}, this));
		this.targetSelector.a(1, new PathfinderGoalHurtByTarget(this, false, new Class[0]));
		this.targetSelector.a(2, getPrivateGoal("PathfinderGoalEndermanPlaceBlock", new Class<?>[]{EntityEnderman.class}, this));
		this.targetSelector.a(2, getPrivateGoal("PathfinderGoalEndermanPickupBlock", new Class<?>[]{EntityEnderman.class}, this));
	...
	@Override
	public boolean k(double a, double b, double c){
		if(isMovable())
			return super.k(a, b, c);
		else return false;
	}
	...
	private PathfinderGoal getPrivateGoal(String name, Class<?>[] forConstructor, Object... objects){
		try {
			...
			for(Class<?> clazz : EntityEnderman.class.getDeclaredClasses()){
