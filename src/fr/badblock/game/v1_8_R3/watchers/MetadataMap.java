    ...
    public static final class Entry implements Comparable<Entry> {
        ...
        public static Entry fromWatchable(WatchableObject nmsObject, Class<? extends Entity> entity) {
            ...
            if (metadataIndex == null)
                throw new IllegalArgumentException("This watchable object is not appliable to the entity. Index = " + index + " / Type = " + itemType + " / Entity = " + entity.getName() + " / Value = " + nmsObject.b());
