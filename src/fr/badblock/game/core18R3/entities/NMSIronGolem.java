...
public class NMSIronGolem extends EntityIronGolem implements NMSCustomCreature {
	...
	public void regenerateAttributes() {
		...
		buildTargetSelector(3, EntityIronGolem.class,
				"PathfinderGoalNearestGolemTarget", new Class<?>[] { EntityCreature.class, Class.class, int.class,
						boolean.class, boolean.class, Predicate.class },
