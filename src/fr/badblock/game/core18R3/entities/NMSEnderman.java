...
public class NMSEnderman extends EntityEnderman implements NMSCustomCreature {
	...
	public void regenerateAttributes() {
		...
		buildTargetSelector(2, EntityEnderman.class, "PathfinderGoalPlayerWhoLookedAtTarget",
				new Class<?>[] { EntityEnderman.class }, this);
		this.targetSelector.a(1, new PathfinderGoalHurtByTarget(this, false, new Class[0]));
		buildTargetSelector(2, EntityEnderman.class, "PathfinderGoalEndermanPlaceBlock",
				new Class<?>[] { EntityEnderman.class }, this);
		buildTargetSelector(2, EntityEnderman.class, "PathfinderGoalEndermanPickupBlock",
				new Class<?>[] { EntityEnderman.class }, this);
		this.targetSelector.a(3, new PathfinderGoalNearestAttackableTarget<>(this, EntityEndermite.class, 10, true,
				false, new Predicate() {
