...
public class NMSGhast extends EntityGhast implements NMSCustomCreature {
	...
	public void regenerateAttributes() {
		...
		buildGoalSelector(7, EntityGhast.class, "PathfinderGoalGhastMoveTowardsTarget",
				new Class[] { EntityGhast.class }, this);
		buildGoalSelector(7, EntityGhast.class, "PathfinderGoalGhastAttackTarget", new Class[] { EntityGhast.class },
				this);
