...
public class NMSPigZombie extends EntityPigZombie implements NMSCustomCreature {
	@Getter
	@Setter
	...
	public void regenerateAttributes() {
		...
		buildTargetSelector(2, EntityPigZombie.class, "PathfinderGoalAngerOther",
				new Class<?>[] { EntityPigZombie.class }, this);
		buildTargetSelector(2, EntityPigZombie.class, "PathfinderGoalAnger", new Class<?>[] { EntityPigZombie.class },
				this);
	}
}
