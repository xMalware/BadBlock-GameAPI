...
public class NMSHorse extends EntityHorse implements NMSCustomCreature {
	@Getter@Setter
	...
	public void regenerateAttributes(){
	    ...
	    if(!hasCreatureFlag(CreatureFlag.RIDEABLE))  this.goalSelector.a(1, new PathfinderGoalTame(this, 1.2D));
