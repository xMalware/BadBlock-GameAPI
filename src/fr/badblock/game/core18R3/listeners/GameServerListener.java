...
public class GameServerListener extends BadListener {
	...
	public void onJoin(PlayerJoinEvent event) {
		// On renvoit les infos mises � jour, avec 0 joueurs en plus envoy� �
		// Docker car lors du PlayerJoinEvent le joueur est d�j� list� dans la
	...
	public void onQuit(PlayerQuitEvent event) {
		// On update, avec -1 joueurs en plus envoy� � Docker car lors du
		// PlayerQuitEvent le joueur est toujours list� dans la liste des
		// joueurs connect�s
