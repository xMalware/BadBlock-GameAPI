...
public class TeleportAllCommand extends AbstractCommand {
	...
	public boolean executeCommand(CommandSender sender, String[] args) {
		...
		GameAPI.i18n().sendMessage(sender, "commands.teleport.to-other",
				concerned.getTranslatedMessage("commands.teleport.all"), concerned.getName());
		return true;
	}
	...
	protected boolean tppos(CommandSender sender, String[] args) {
