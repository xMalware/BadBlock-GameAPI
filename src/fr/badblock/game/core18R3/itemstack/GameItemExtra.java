...
public class GameItemExtra implements ItemStackExtra {
	...
	public ItemStackExtra listenAs(ItemEvent optionalEvent, ItemPlaces place) {
		...
		if (place == ItemPlaces.HOTBAR_CLICKABLE || place == ItemPlaces.INVENTORY_CLICKABLE) {
			listen(optionalEvent, ItemAction.INVENTORY_LEFT_CLICK, ItemAction.INVENTORY_RIGHT_CLICK,
					ItemAction.LEFT_CLICK_AIR, ItemAction.LEFT_CLICK_BLOCK, ItemAction.RIGHT_CLICK_AIR,
					ItemAction.RIGHT_CLICK_BLOCK);
		}

		if (place == ItemPlaces.HOTBAR_UNCLICKABLE || place == ItemPlaces.INVENTORY_UNCLICKABLE) {
			disallow(ItemAction.INVENTORY_LEFT_CLICK, ItemAction.INVENTORY_RIGHT_CLICK, ItemAction.LEFT_CLICK_AIR,
					ItemAction.LEFT_CLICK_BLOCK, ItemAction.RIGHT_CLICK_AIR, ItemAction.RIGHT_CLICK_BLOCK);
		}
