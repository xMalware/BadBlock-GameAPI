...
public abstract class GameBadblockOutPacket extends GameBadblockPacket implements BadblockOutPacket {
	@Getter
	public enum GameBadblockOutPackets {
		ABILITIES(PlayAbilities.class, PacketPlayOutAbilities.class), ANIMATION(PlayAnimation.class,
				PacketPlayOutAnimation.class), ATTACH_ENTITY(PlayAttachEntity.class,
						PacketPlayOutAttachEntity.class), BED(PlayBed.class, PacketPlayOutBed.class), BLOCK_ACTION(
								PlayBlockAction.class,
								PacketPlayOutBlockAction.class), BLOCK_BREAK_ANIMATION(PlayBlockBreakAnimation.class,
										PacketPlayOutBlockBreakAnimation.class), BLOCK_CHANGE(PlayBlockChange.class,
												PacketPlayOutBlockChange.class), CAMERA(PlayCamera.class,
														PacketPlayOutCamera.class), CHANGE_GAMESTATE(
																PlayChangeGameState.class,
																PacketPlayOutGameStateChange.class), CHAT(
																		PlayChat.class,
																		PacketPlayOutChat.class), CLOSE_WINDOW(
																				PlayCloseWindow.class,
																				PacketPlayOutCloseWindow.class), COLLECT(
																						PlayCollect.class,
																						PacketPlayOutCollect.class), COMBAT_EVENT(
																								PlayCombatEvent.class,
																								PacketPlayOutCombatEvent.class), CUSTOM_PAYLOAD(
																										PlayCustomPayload.class,
																										PacketPlayOutCustomPayload.class), DISCONNECT(
																												PlayDisconnect.class,
																												PacketPlayOutKickDisconnect.class), ENTITY_DESTROY(
																														PlayEntityDestroy.class,
																														PacketPlayOutEntityDestroy.class), ENTITY_EFFECT(
																																PlayEntityEffect.class,
																																PacketPlayOutEntityEffect.class), ENTITY_EQUIPMENT(
																																		PlayEntityEquipment.class,
																																		PacketPlayOutEntityEquipment.class), ENTITY_HEAD_ROTATION(
																																				PlayEntityHeadRotation.class,
																																				PacketPlayOutEntityHeadRotation.class), ENTITY_LOOK(
																																						PlayEntityLook.class,
																																						PacketPlayOutEntityLook.class), ENTITY_METADATA(
																																								PlayEntityMetadata.class,
																																								PacketPlayOutEntityMetadata.class), ENTITY_RELATIVE_MOVE(
																																										PlayEntityRelativeMove.class,
																																										PacketPlayOutRelEntityMove.class), ENTITY_STATUS(
																																												PlayEntityStatus.class,
																																												PacketPlayOutEntityStatus.class), ENTITY_TELEPORT(
																																														PlayEntityTeleport.class,
																																														PacketPlayOutEntityTeleport.class), ENTITY_VELOCITY(
																																																PlayEntityVelocity.class,
																																																PacketPlayOutEntityVelocity.class), EXPERIENCE(
																																																		PlayExperience.class,
																																																		PacketPlayOutExperience.class), EXPLOSION(
																																																				PlayExplosion.class,
																																																				PacketPlayOutExplosion.class), HELD_ITEM_SLOT(
																																																						PlayHeldItemSlot.class,
																																																						PacketPlayOutHeldItemSlot.class), KEEP_ALIVE(
																																																								PlayKeepAlive.class,
																																																								PacketPlayOutKeepAlive.class), LOGIN(
																																																										PlayLogin.class,
																																																										PacketPlayOutLogin.class), MAP(
																																																												PlayMap.class,
																																																												PacketPlayOutMap.class), MAP_CHUNK(
																																																														PlayMapChunk.class,
																																																														PacketPlayOutMapChunk.class), MAP_CHUNK_BULK(
																																																																PlayMapChunkBulk.class,
																																																																PacketPlayOutMapChunkBulk.class), MULTI_BLOCK_CHANGE(
																																																																		PlayMultiBlockChange.class,
																																																																		PacketPlayOutMultiBlockChange.class), NAMED_ENTITY_SPAWN(
																																																																				PlayNamedEntitySpawn.class,
																																																																				PacketPlayOutNamedEntitySpawn.class), NAMED_SOUND_EFFECT(
																																																																						PlayNamedSoundEffect.class,
																																																																						PacketPlayOutNamedSoundEffect.class), OPEN_SIGN_EDITOR(
																																																																								PlayOpenSignEditor.class,
																																																																								PacketPlayOutOpenSignEditor.class), OPEN_WINDOW(
																																																																										PlayOpenWindow.class,
																																																																										PacketPlayOutOpenWindow.class), PLAYER_INFO(
																																																																												PlayPlayerInfo.class,
																																																																												PacketPlayOutPlayerInfo.class), PLAYER_LIST_HEADER_FOOTER(
																																																																														PlayPlayerListHeaderFooter.class,
																																																																														PacketPlayOutPlayerListHeaderFooter.class), POSITION(
																																																																																PlayPosition.class,
																																																																																PacketPlayOutPosition.class), REMOVE_ENTITY_EFFECT(
																																																																																		PlayRemoveEntityEffect.class,
																																																																																		PacketPlayOutRemoveEntityEffect.class), RESOURCE_PACK_SEND(
																																																																																				PlayResourcePackSend.class,
																																																																																				PacketPlayOutResourcePackSend.class), SCOREBOARD_DISPLAYOBJECTIVE(
																																																																																						PlayScoreboardDisplayObjective.class,
																																																																																						PacketPlayOutScoreboardDisplayObjective.class), SCOREBOARD_OBJECTIVE(
																																																																																								PlayScoreboardObjective.class,
																																																																																								PacketPlayOutScoreboardObjective.class), SCOREBOARD_SCORE(
																																																																																										PlayScoreboardScore.class,
																																																																																										PacketPlayOutScoreboardScore.class), SCOREBOARD_TEAM(
																																																																																												PlayScoreboardTeam.class,
																																																																																												PacketPlayOutScoreboardTeam.class), SERVER_DIFFICULTY(
																																																																																														PlayServerDifficulty.class,
																																																																																														PacketPlayOutServerDifficulty.class), SET_SLOT(
																																																																																																PlaySetSlot.class,
																																																																																																PacketPlayOutSetSlot.class), SPAWN_ENTITY_CREATURE(
																																																																																																		PlaySpawnEntityCreature.class,
																																																																																																		PacketPlayOutSpawnEntityLiving.class), SPAWN_ENTITY_EXPERIENCE_ORB(
																																																																																																				PlaySpawnEntityExperienceOrb.class,
																																																																																																				PacketPlayOutSpawnEntityExperienceOrb.class), SPAWN_ENTITY_OBJECT(
																																																																																																						PlaySpawnEntityObject.class,
																																																																																																						PacketPlayOutEntity.class), SPAWN_ENTITY_PAINTING(
																																																																																																								PlaySpawnEntityPainting.class,
																																																																																																								PacketPlayOutSpawnEntityPainting.class), SPAWN_ENTITY_WEATHER(
																																																																																																										PlaySpawnEntityWeather.class,
																																																																																																										PacketPlayOutSpawnEntityWeather.class), SPAWN_POSITION(
																																																																																																												PlaySpawnPosition.class,
																																																																																																												PacketPlayOutSpawnPosition.class), STATISTIC(
																																																																																																														PlayStatistic.class,
																																																																																																														PacketPlayOutStatistic.class), TAB_COMPLETE(
																																																																																																																PlayTabComplete.class,
																																																																																																																PacketPlayOutTabComplete.class), TILE_ENTITY_DATA(
																																																																																																																		PlayTileEntityData.class,
																																																																																																																		PacketPlayOutTileEntityData.class), TITLE(
																																																																																																																				PlayTitle.class,
																																																																																																																				PacketPlayOutTitle.class), TRANSACTION(
																																																																																																																						PlayTransaction.class,
																																																																																																																						PacketPlayOutTransaction.class), UPDATE_ATTRIBUTES(
																																																																																																																								PlayUpdateAttributes.class,
																																																																																																																								PacketPlayOutUpdateAttributes.class), UPDATE_HEALTH(
																																																																																																																										PlayUpdateHealth.class,
																																																																																																																										PacketPlayOutUpdateHealth.class), UPDATE_SIGN(
																																																																																																																												PlayUpdateSign.class,
																																																																																																																												PacketPlayOutUpdateSign.class), UPDATE_TIME(
																																																																																																																														PlayUpdateTime.class,
																																																																																																																														PacketPlayOutUpdateTime.class), WINDOW_DATA(
																																																																																																																																PlayWindowData.class,
																																																																																																																																PacketPlayOutWindowData.class), WINDOW_ITEMS(
																																																																																																																																		PlayWindowItems.class,
																																																																																																																																		PacketPlayOutWindowItems.class), WORLD_BORDER(
																																																																																																																																				PlayWorldBorder.class,
																																																																																																																																				PacketPlayOutWorldBorder.class), RESPAWN(
																																																																																																																																						PlayRespawn.class,
																																																																																																																																						PacketPlayOutRespawn.class), WORLD_PARTICLES(
																																																																																																																																								PlayWorldParticles.class,
		...
		<T extends BadblockOutPacket> GameBadblockOutPackets(Class<T> clazz, Class<? extends Packet<?>> nmsClass) {
			...
			try {
				this.gameClazz = (Class<? extends GameBadblockOutPacket>) Class
						.forName("fr.badblock.game.core18R3.packets.out.Game" + clazz.getSimpleName());
