...
public class GamePlayTitle extends GameBadblockOutPacket implements PlayTitle {
	...
	public GamePlayTitle(PacketPlayOutTitle packet) {
		...
		try {
			content = BaseComponent.toLegacyText(fromChat((IChatBaseComponent) reflector.getFieldValue("b")));
	...
	public Packet<?> buildPacket() throws Exception {
		return new PacketPlayOutTitle(EnumTitleAction.valueOf(action.name()), getChat(content), (int) fadeIn,
