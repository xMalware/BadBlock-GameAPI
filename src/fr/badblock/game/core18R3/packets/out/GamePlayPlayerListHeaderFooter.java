...
public class GamePlayPlayerListHeaderFooter extends GameBadblockOutPacket implements PlayPlayerListHeaderFooter {
	...
	public GamePlayPlayerListHeaderFooter(PacketPlayOutPlayerListHeaderFooter packet) {
		...
		try {
			header = BaseComponent.toLegacyText(fromChat((IChatBaseComponent) reflector.getFieldValue("a")));
			footer = BaseComponent.toLegacyText(fromChat((IChatBaseComponent) reflector.getFieldValue("b")));
		} catch (Exception e) {
		}
	}
