...
import fr.badblock.game.core18R3.players.utils.particle.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	 ...
	 */
	public void display(BadblockPlayer player, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
		if (!isSupported()) {
		...
		new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount, range > 256, null).sendTo(player, center, range);
	}
	 ...
	 * @see ParticlePacket#sendTo(Location, double)
	 */
	public void display(BadblockPlayer player, Vector direction, float speed, Location center, double range) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
		if (!isSupported()) {
			throw new ParticleVersionException("This particle effect is not supported by your server version");
		}
		if (hasProperty(ParticleProperty.REQUIRES_DATA)) {
		...
		new ParticlePacket(this, direction, speed, range > 256, null).sendTo(player, center, range);
	}
	 ...
	 * @see ParticlePacket#sendTo(Location, double)
	 */
	public void display(BadblockPlayer player, ParticleColor color, Location center, double range) throws ParticleVersionException, ParticleColorException {
		if (!isSupported()) {
			throw new ParticleVersionException("This particle effect is not supported by your server version");
		}
		...
		new ParticlePacket(this, color, range > 256).sendTo(player, center, range);
	}
	 ...
	 * @see ParticlePacket#sendTo(Location, double)
	 */
	public void display(BadblockPlayer player, ParticleData data, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range) throws ParticleVersionException, ParticleDataException {
		if (!isSupported()) {
			throw new ParticleVersionException("This particle effect is not supported by your server version");
		}
		if (!hasProperty(ParticleProperty.REQUIRES_DATA)) {
		...
		new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount, range > 256, data).sendTo(player, center, range);
	}
	 ...
	 * @see ParticlePacket#sendTo(Location, double)
	 */
	public void display(BadblockPlayer player, ParticleData data, Vector direction, float speed, Location center, double range) throws ParticleVersionException, ParticleDataException {
		if (!isSupported()) {
			throw new ParticleVersionException("This particle effect is not supported by your server version");
		}
		if (!hasProperty(ParticleProperty.REQUIRES_DATA)) {
		...
		new ParticlePacket(this, direction, speed, range > 256, data).sendTo(player, center, range);
	}
	...
	public static final class ParticlePacket {
		 ...
		 * @see #sendTo(Location center, Player player)
		 */
		public void sendTo(BadblockPlayer player, Location center, double range) throws IllegalArgumentException {
			if (range < 1) {
