...
public enum GameWatchers {
	AGEABLE(WatcherAgeable.class, GameWatcherAgeable.class, Ageable.class), ARMOR_STAND(WatcherArmorStand.class,
			GameWatcherArmorStand.class,
			ArmorStand.class), BLAZE(WatcherBlaze.class, GameWatcherBlaze.class, Blaze.class), CREEPER(
					WatcherCreeper.class, GameWatcherCreeper.class,
					Creeper.class), ENDERMAN(WatcherEnderman.class, GameWatcherEnderman.class, Enderman.class), ENTITY(
							WatcherEntity.class, GameWatcherEntity.class,
							Entity.class), GHAST(WatcherGhast.class, GameWatcherGhast.class, Ghast.class), HORSE(
									WatcherHorse.class, GameWatcherHorse.class,
									Horse.class), IRON_GOLEM(WatcherIronGolem.class, GameWatcherIronGolem.class,
											IronGolem.class), LIVING_ENTITY(WatcherLivingEntity.class,
													GameWatcherLivingEntity.class, LivingEntity.class), OCELOT(
															WatcherOcelot.class, GameWatcherOcelot.class,
															Ocelot.class), PIG(WatcherPig.class, GameWatcherPig.class,
																	Pig.class), RABBIT(WatcherRabbit.class,
																			GameWatcherRabbit.class,
																			Rabbit.class), SHEEP(WatcherSheep.class,
																					GameWatcherSheep.class,
																					Sheep.class), SKELETON(
																							WatcherSkeleton.class,
																							GameWatcherSkeleton.class,
																							Skeleton.class), SLIME(
																									WatcherSlime.class,
																									GameWatcherSlime.class,
																									Slime.class), TAMEABLE_ANIMAL(
																											WatcherTameableAnimal.class,
																											GameWatcherTameableAnimal.class,
																											Tameable.class), VILLAGER(
																													WatcherVillager.class,
																													GameWatcherVillager.class,
																													Villager.class), WITCH(
																															WatcherWitch.class,
																															GameWatcherWitch.class,
																															Witch.class), WITHER(
																																	WatcherWither.class,
																																	GameWatcherWither.class,
																																	Wither.class), WOLF(
																																			WatcherWolf.class,
																																			GameWatcherWolf.class,
																																			Wolf.class), ZOMBIE(
																																					WatcherZombie.class,
																																					GameWatcherZombie.class,
																																					Zombie.class);
	...
	public static <T extends WatcherEntity> T buildWatch(Class<T> classWatcher) {
		for (GameWatchers watcher : values()) {
			if (watcher.clazz.equals(classWatcher)) {
				try {
					return (T) watcher.gameClazz.getConstructor(Entity.class.getClass())
							.newInstance(watcher.getBukkitClazz());
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	@Getter
	private final Class<? extends WatcherEntity> clazz;
	@Getter
	private final Class<? extends WatcherEntity> gameClazz;

	@Getter
	private final Class<?> bukkitClazz;
